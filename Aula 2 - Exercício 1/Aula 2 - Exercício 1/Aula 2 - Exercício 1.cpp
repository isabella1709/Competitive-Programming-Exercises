...
int main(int argc, char* argv[]) {
    ...
    int n, q;
    vi inventory; vvi adjustments;
    cin >> n;
    read_vi(inventory, n);     
    cin >> q;
    read_vvi(adjustments, q);

    vll results;
    results.reserve(inventory.size());
    ...
    for (const auto& adjustment : adjustments) {
        ...
        auto sum = reduce(
            ...
            inventory.begin(),        // Início do intervalo do vetor humidity1.
            inventory.end(),          // Fim do intervalo do vetor humidity1.
